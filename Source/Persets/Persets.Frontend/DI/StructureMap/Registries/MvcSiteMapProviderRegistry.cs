...
namespace Persets.Frontend.DI.StructureMap.Registries
{
        ...
        : Registry
    {
        public MvcSiteMapProviderRegistry()
        {
            ...
            string[] includeAssembliesForScan = new string[] { "Persets.Frontend" };
...
// Configure Security
            ...
            Assembly resourceAssembly = typeof(Persets.Frontend.ViewResources.Menu.Resource).Assembly;
            ...
            var resourceManager = this.For<ResourceManager>()
                .Use(() => new ResourceManager(resourceBaseName, resourceAssembly));
